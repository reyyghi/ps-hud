...
Config.FuelScript = 'rhd_fuel' -- change to lj-fuel if you use lj-fuel or something else if you use another LegcyFuel compatible script. and you can also change it to ox_fuel if you use ox_fuel
